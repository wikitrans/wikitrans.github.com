...
The file contains these contents (when this is rendered in my web browser there are some boxes that apprea, that aren't there when you click on "raw"):
<script src="http://gist.github.com/279534.js?file=gistfile2.py"></script>
