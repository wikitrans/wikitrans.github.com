...
Peter brings up a slide for Naive Bayes word modeling and mentions using a Python Decorator for memoization. I had not considered implementing memoization this way, but now that I've come across it, I can't imagine doing it a different way. It's so concise.

I found this <a href="http://avinashv.net/2008/04/python-decorators-syntactic-sugar/">blog post</a> compelling for decorators. Memoization is covered.
