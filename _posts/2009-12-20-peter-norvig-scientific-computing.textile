...
I found this <a href="http://avinashv.net/2008/04/python-decorators-syntactic-sugar/">blog post</a> compelling for decorators. Memoization is covered. I have had good success use Django's for requiring authentication properties before like <code>@login_required</code>.

<i>I think the was the appropriate amount of work to get there.</i>
