...
I have begun work on a python module for interfacing with the Wikipedia API. It is currently at a 0.1 release and covers the gist of what WikiTrans needs from Wikipedia, though I expect this to expand as time goes by.
